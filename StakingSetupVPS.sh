...
wget https://github.com/comunidaddcoins/Triskelpremium/releases/download/1.1.0/triskelpremium-1.1.0-x86_64-linux-gnu.tar.gz
tar -xzf triskelpremium-1.1.0-x86_64-linux-gnu.tar.gz
...
echo "addnode=45.32.139.67" >> triskelpremium.conf
echo "addnode=45.32.49.196" >> triskelpremium.conf
